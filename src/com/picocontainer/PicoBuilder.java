...
import static com.picocontainer.injectors.Injectors.adaptiveDI;
import static com.picocontainer.injectors.Injectors.annotatedFieldDI;
import static com.picocontainer.injectors.Injectors.annotatedMethodDI;
import static com.picocontainer.injectors.Injectors.namedField;
import static com.picocontainer.injectors.Injectors.namedMethod;
import static com.picocontainer.injectors.Injectors.typedFieldDI;
...
public class PicoBuilder {
    ...
    /**
     * Constructed PicoContainer will use {@linkplain com.picocontainer.lifecycle.ReflectionLifecycleStrategy ReflectionLifecycle}.
     *
    ...
    /**
     * Constructed PicoContainer will use {@linkplain com.picocontainer.lifecycle.JavaEE5LifecycleStrategy JavaEE5LifecycleStrategy}.
     *
     * @return <em>this</em> to allow for method chaining.
     */
    ...
    public MutablePicoContainer build() {
        ...
        Stack<?> clonedBehaviors = (Stack<?>) behaviors.clone();
        ...
        if (lifecycle == null) {
            ...
            tempContainer.addComponent(LifecycleStrategy.class, (Object) lifecycle);
    ...
    private ComponentFactory buildComponentFactory(final DefaultPicoContainer container, final ComponentFactory lastCaf, final Stack<?> clonedBehaviors) {
