...
public abstract class AbstractPicoContainerTest {
    ...
    public void testDuplicateRegistration() {
        try {
            ...
            assertTrue("Wrong key", e.getMessage().contains(Object.class.toString()));
        }
    }
    ...
    public void testPico52() {
        ...
        pico.addComponent("foo", JMSService.class, new ConstantParameter<>("0"),
    ...
    public void testAggregatedVerificationException() {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains(ComponentA.class.getName()));
            assertTrue(e.getMessage().contains(ComponentE.class.getName()));
        }
    }
...
//    }
    ...
    public void testStartStopAndDisposeNotCascadedtoRemovedChildren() {
        ...
        parent.start();
        assertTrue(!sb.toString().contains("-started"));
        parent.stop();
        assertTrue(!sb.toString().contains("-stopped"));
        parent.dispose();
        assertTrue(!sb.toString().contains("-disposed"));
    }
    ...
    public void testAcceptImplementsBreadthFirstStrategy() {
        ...
        List<Object> visitedList = new LinkedList<>();
...
//        assertEquals(0, visitedList.size());
    ...
    protected void addDefaultComponentFactories(final List<Class<?>> expectedList) {
    ...
    public void testAmbiguousDependencies() throws PicoCompositionException {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains(DerivedTouchable.class.getName()));
            assertTrue(e.getMessage().contains("public com.picocontainer.testmodel.DependsOnTouchable(com.picocontainer.testmodel.Touchable)"));
        }
    }
    ...
    public void testNullValuesDoNotInject() {
        MutablePicoContainer pico = createPicoContainer(null);
        pico.addComponent(ConstantParameterTestService.class, ConstantParameterTestService.class,
                new ConstantParameter<>(null));
        try {
            ConstantParameterTestService service = pico.getComponent(ConstantParameterTestService.class);
