...
public class Issue0316TestCase {
    ...
    private void doTest(final Class targetClass) {
    ...
    public static class GoodTarget implements Target {
        ...
        public void injectNumber(final Integer number)  {
            this.number = number;
        }

        public void injectFruit1(final Fruit fruit1) {
            this.fruit1 = fruit1;
        }

        public void injectFruit2(final Fruit fruit2) {
            this.fruit2 = fruit2;
        }
