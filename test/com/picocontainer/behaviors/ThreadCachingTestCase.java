...
public class ThreadCachingTestCase {
    ...
    @Test public void testThatForASingleThreadTheBehaviorIsTheSameAsPlainCaching() {
        ...
        assertEquals("ThreadCached:LifecycleAdapter:CompositeInjector(LifecycleAdapter)-class com.picocontainer.behaviors.ThreadCachingTestCase$Foo", child.getComponentAdapter(Foo.class).toString());
    }
    ...
    @Test public void testThatForASingleThreadTheBehaviorIsTheSameAsPlainCachingWithSetterInjection() {
        ...
        assertEquals("ThreadCached:LifecycleAdapter:SetterInjector-class com.picocontainer.behaviors.ThreadCachingTestCase$Baz", child.getComponentAdapter(Baz.class).toString());
    }
    ...
    @Test public void testThatTwoThreadsHaveSeparatedCacheValuesWithCompositeInjection() throws InterruptedException {
        ...
        assertEquals("ThreadCached:CompositeInjector(ConstructorInjector+SetterInjector)" +
        		"-class com.picocontainer.behaviors.ThreadCachingTestCase$Qux", child.getComponentAdapter(Qux.class).toString());
    }
    ...
    @Test public void testThatTwoThreadsHaveSeparatedCacheValuesWithInstanceRegistrationAndClassLoadingPicoContainer() {
        ...
        assertFalse(foos[0] == foos[1]);
        assertEquals("<Foo<Foo", sb.toString());
        assertEquals("ThreadCached:CompositeInjector(ConstructorInjector)-class com.picocontainer.behaviors.ThreadCachingTestCase$Foo", child.getComponentAdapter(Foo.class).toString());
    }
    ...
    @Test public void testThatTwoThreadsHaveSeparatedCacheValuesForThreeScopeScenario() {
        ...
        assertEquals("ThreadCached:LifecycleAdapter:CompositeInjector(LifecycleAdapter)-class com.picocontainer.behaviors.ThreadCachingTestCase$Foo", sessionScope.getComponentAdapter(Foo.class).toString());
    }
